...
function CreatePollModal(): JSX.Element {
  ...
  return (
    <Modal
      ...
      title={isLoading ? 'Creating Poll...' : 'Create Poll'}
    >
      <form className="form-control relative w-full max-w-xs mx-auto gap-3" onSubmit={handleSubmitNewPoll}>
        {isLoading
          ? <BeatLoader loading className="mx-auto mt-4" color="#fff" />
          : (
            <>
              <div>
